...
public class ClassVarDeclListX extends ClassVarDeclList {

    private ClassVarDeclList ClassVarDeclList;
    private ClassVarDecl ClassVarDecl;

    public ClassVarDeclListX (ClassVarDeclList ClassVarDeclList, ClassVarDecl ClassVarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassVarDeclListX(\n");
