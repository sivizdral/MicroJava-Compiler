...
public class MethodDecl2 implements SyntaxNode {
    ...
    public MethodDecl2 (FormParsOptional FormParsOptional, VarDeclList VarDeclList, StatementList StatementList) {
