...
public class FirstConstructorDecl implements SyntaxNode {
    ...
    public FirstConstructorDecl (FormParsOptional FormParsOptional, VarDeclList VarDeclList, StatementList StatementList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FirstConstructorDecl(\n");
