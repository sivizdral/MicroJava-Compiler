...
public class FirstConstructorDeclDerived1 extends FirstConstructorDecl {

    private FormParsOptional FormParsOptional;
    private VarDeclList VarDeclList;
    private StatementList StatementList;

    public FirstConstructorDeclDerived1 (FormParsOptional FormParsOptional, VarDeclList VarDeclList, StatementList StatementList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FirstConstructorDeclDerived1(\n");
